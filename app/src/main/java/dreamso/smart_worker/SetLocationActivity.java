...
public class SetLocationActivity extends AppCompatActivity implements OnMapReadyCallback,
                ...
                try {
                    ...
                    if (addressList != null && addressList.size() > 0) {
                        ...
                        if (!locality.isEmpty() && !country.isEmpty()) {
                            lattitiude = Double.toString(latLng.latitude);
    ...
    public String category,title,description,mobile,address,lattitiude,longtitiude;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        description = getIntent().getStringExtra("mobileNumber");
        mobile = getIntent().getStringExtra("description");
    ...
    private void moveCamera(LatLng latLng, float zoom, PlaceInfo placeInfo){
        ...
        mMap.setInfoWindowAdapter(new CustomInfoWindowAdapter(SetLocationActivity.this));
